      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 p-6 mt-23 overflow-auto">
            <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow border border-gray-200 space-y-5 w-full">
                ...
                <div>
                <label className="block text-sm text-gray-600 mb-2 kanit-regular ">ชื่อลูกค้า <span className="text-red-500">*</span></label>
                <input 
                    required 
                ...
                <div>
                    ...
                    disabled
                    placeholder="30 Day" 
                    className="w-full border border-gray-300 rounded-md px-3 py-2.5 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-600 focus:border-transparent kanit-regular cursor-not-allowed"
                    />
                </div>
                </div>
                ...
                <textarea
                    ...
                    className="w-full border border-gray-300 rounded-md px-3 py-2.5 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-600 focus:border-transparent resize-none kanit-regular cursor-not-allowed" 
                    rows="4"
                />
                </div>
